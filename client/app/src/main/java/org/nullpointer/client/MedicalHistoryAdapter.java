...
public class MedicalHistoryAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null)
        {
            ...
            medicalHistoryHolder.showSymptoms = (TextView) row.findViewById(R.id.symptoms_client_home_screen);
            medicalHistoryHolder.showDateTimeShow = (TextView) row.findViewById(R.id.date_time_client_home_screen);
            medicalHistoryHolder.showMedicalTest = (TextView) row.findViewById(R.id.medical_test_client_home_screen);
            medicalHistoryHolder.showMedicinesPrescribed = (TextView) row.findViewById(R.id.medicines_prescribed_client_home_screen);
