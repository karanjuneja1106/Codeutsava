...
public class ClientMedicalHistory extends AppCompatActivity {
    String JSON_STRING;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_medical_history);
        medicalHistoryAdapter = new MedicalHistoryAdapter(this,R.layout.layout_medical_history);
        listView = (ListView) findViewById(R.id.listViewMedicalHistoryClientHomeScreen);
