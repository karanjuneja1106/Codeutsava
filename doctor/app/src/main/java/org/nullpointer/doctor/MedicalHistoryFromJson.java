...
public class MedicalHistoryFromJson {
    ...
    MedicalHistoryFromJson(Context context, String mailIdString) {
        this.context = context;

        BackgroundTask bt = new BackgroundTask(context);
        bt.execute(mailIdString);

    }


    public void goToMedicalHistoryClientScreen() {
    ...
    public class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String CLIENT_MEDICAL_HISTORY_MAIL_ID = params[0];
            ...
            try {
                ...
                String data = URLEncoder.encode("CLIENT_MEDICAL_HISTORY_MAIL_ID", "UTF-8") + "=" + URLEncoder.encode(CLIENT_MEDICAL_HISTORY_MAIL_ID, "UTF-8");
